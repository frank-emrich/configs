...
export ZSH="/home/frank/.config/configs/zsh/oh-my-zsh/"
...
ZSH_CUSTOM=~/.config/configs/zsh/oh-my-zsh-custom
...
#    PROMPT_COMMAND="$PROMPT_COMMAND ; _append_break"
 ...
 #   source ~/.config/configs/bash-preexec/bash-preexec/bash-preexec.sh
